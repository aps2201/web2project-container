...
This is a containerization for [web2Project](https://github.com/web2project/web2project). It builds upon the [php:8.4-apache](https://hub.docker.com/_/php/) docker image.
...
To create a mysql database you can use the [official docker image](https://hub.docker.com/_/mysql/) and add it to the pod: `podman run --replace --name w2p-mysql --pod w2p -e MYSQL_ROOT_PASSWORD=[root_password] -e MYSQL_DATABASE=w2p -e MYSQL_USER=w2p -e MYSQL_PASSWORD=[db_password] -d docker.io/library/mariadb:lts`
